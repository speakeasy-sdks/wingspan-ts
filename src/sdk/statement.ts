...
export class Statement {
    ...
    async download(
        ...
        const res: operations.DownloadStatementResponse = new operations.DownloadStatementResponse({
    ...
    async get(id: string, config?: AxiosRequestConfig): Promise<operations.GetStatementResponse> {
        ...
        const res: operations.GetStatementResponse = new operations.GetStatementResponse({
            statusCode: httpRes.status,
            contentType: responseContentType,
            rawResponse: httpRes,
        });
