...
export class AdditionalData {
    ...
    async create(
    ...
    ): Promise<operations.CreateAdditionalDataResponse> {
        ...
        const res: operations.CreateAdditionalDataResponse =
            new operations.CreateAdditionalDataResponse({
    ...
    async delete(
        ...
        const res: operations.DeleteAdditionalDataResponse =
            new operations.DeleteAdditionalDataResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    async get(
        ...
        const res: operations.GetAdditionalDataResponse = new operations.GetAdditionalDataResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
